...
|------|:----:|---------|
| Free | **¥0** | 下载即用 |
| Pro 永久 | **¥29.9** | [面包多购买激活码](https://mianbaoduo.com/) |
...
3. 点击「加载已解压的扩展程序」
4. 选择 `extension/` 目录
5. 打开 `creator.xiaohongshu.com` 进入笔记编辑页即可看到工具栏
...
| 版本 | 价格 | 功能 |
|------|------|------|
| Free | ¥0 | 基础排版（字号/行距/颜色/加粗/对齐） |
| Pro | ¥29.9 终身 | 模板库、配色方案、格式清理、自定义模板 |
