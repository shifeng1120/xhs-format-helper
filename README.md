...
一款专为小红书创作者、运营、店主和知识博主打造的 Chrome 插件。它把「正文排版、手机预览、账号风格、历史草稿、封面、图文卡片、AI 配图、话题标签」整合到发布页里，让普通文案更快变成可发布、可收藏、可转化的笔记。
...
### 方式二：Edge 浏览器（即将上架）
Edge 扩展商店搜索「红薯创作助手」即可安装（Chrome 插件兼容）。
...
|------|:----:|---------|
| Free | **¥0** | 下载即用（基础功能） |
| 试用版 | **¥0** | 安装后自动获得 7 天 Pro 试用 |
| Pro 月付 | **¥9.9/月** | 适合个人创作者长期使用 |
| Pro 年付 | **¥68/年** | 平均不到 ¥6/月 |
| 早鸟终身 | **¥129** | 本地能力长期使用，AI 额度另计 |
| 运营版 | **¥29/月** | 适合店主、代运营和内容运营者 |

购买 Pro 后，在插件设置页或工具箱中点击「已有激活码？」输入激活码即可解锁对应功能。
